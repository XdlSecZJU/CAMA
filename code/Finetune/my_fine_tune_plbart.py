...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PLBART finetuning on Seq2Seq LM task")
    ...
    parser.add_argument('--cache-data', default='cache_data/summarize_plbart', type=str)
    parser.add_argument('--load', default='./plbart-base', type=str)
    ...
    # Logging and stuff
    parser.add_argument('--save-dir', default="./my_instruct_plbart_base_3epoch", type=str)
